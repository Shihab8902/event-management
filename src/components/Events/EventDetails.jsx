...
const EventDetails = () => {
    ...
    return <div className='mt-12 mb-20'>
        <div>
        ...
        <div>
            ...
            <div>
                <button className='bg-blue-700 w-full py-5 rounded-lg text-white font-bold text-lg uppercase'> Book Event - <span>{price}</span></button>
            </div>
        </div>
    </div>
}
